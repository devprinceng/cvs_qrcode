...
<head>
    <title>New Application | Certificate Verification and Authentication System</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">New Application</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    foreach ($results as $row) {
        ?>
                    ...
                    <?php } else { ?>             <td><?php echo htmlentities($row->Status);?>
                                                                    <td class="datatable-ct"><a href="view-application-detail.php?viewid=
                                                                    <?php echo htmlentities($row->ID); ?>"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
        </tr>
        <?php
        $cnt++;
    }
