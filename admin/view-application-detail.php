                        ...
                        <div class="sparkline13-list shadow-reset">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>View <span class="table-project-n">Details of</span> All Applications</h1>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($row->Status) ?: "Still Pending"; ?></td>
                                                        <td class="datatable-ct">
                                                            <a href="view-application-detail.php?viewid=<?php echo htmlentities($row->ID); ?>">
