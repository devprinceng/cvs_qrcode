...
<head>
  ...
  <title>Forgot Password | Glory-Pretty School Certificate Management System</title>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="login-button-pro" style="text-align:center">
                      ...
                      <button type="submit" class="login-button login-button-lg" name="reset_password">Reset</button>
