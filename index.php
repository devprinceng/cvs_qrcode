...
<head>
    ...
    <title>Home Page - Certificate Verification and Authentication System</title>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">Certificate Verification and Authentication System</a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Glory-Pretty Verification and Authentication System 
